...
try:
    ...
    ENVIAR_ALERTAS = CONFIG.get("dash", True)
    PRECIO_MAXIMO = CONFIG.get("precio_dash", 40999)
...
HISTORIAL_PATH = Path("sent_offers_dash.json")
